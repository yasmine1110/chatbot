  ...
  return (
    ...
    >
      ...
      <main className="flex-1 flex flex-col">
        ...
        <div 
          ref={chatContainerRef}
          className="chat-container rounded-xl px-4 sm:px-10 lg:px-20 py-6 my-6 flex-1 overflow-y-auto scrollbar-thin scrollbar-thumb-blue-300 scrollbar-track-transparent"
        >
          <div className="space-y-4">
            {chatLog.map((msg, i) => (
              <div
        ...
        <div className="flex justify-center px-4 pb-6">
          <div className="bg-white border border-gray-300 px-4 py-3 flex items-center w-full max-w-3xl rounded-full shadow-lg">
            <input
              ...
              type="text"
              placeholder="Posez votre question médicale..." 
              className="flex-1 text-base sm:text-lg border-none outline-none px-4 bg-transparent"
            />
            <button 
              onClick={sendMessage} 
              disabled={isLoading}
